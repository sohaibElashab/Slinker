            ...
            <div className="main__ISC">
                ...
                <div className="content__ISC">
                    ...
                    <div className="metrics__details__list__sc">
                        ...
                        <div className="metrics__height__details__sc metrics__details__sc">
                        ...
                        <div className="list__height__sc list__sc">
                        Page List
                    ...
                    <div className="amazon__products__ISC amazon__products__I">
                        ...
                        <div className="amazon__products__body__ISC">
                            ...
                            <span className="text1__ISC"
                                >Nair Hair Remover for Men Hair Remover Body Cream, 13
                                oz</span
                            >
