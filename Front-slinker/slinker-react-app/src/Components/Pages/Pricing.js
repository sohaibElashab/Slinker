      ...
      <section className="pricing_plan">
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-md-8 text-center">
                <h3 className="mt-3 pricing_title mb-1">
                  Simple Pricing
                  <br /> for everyone
                </h3>
                <h6 className="pricing_subtitle">
                  Choose the Right Plan for you
                </h6>
                <div className="free-months py-5">
                  <img
                    className="img-fluid"
                    src="https://localhost:3000/Assets/Get 2 months for free.svg"
                    alt=""
                  />
                </div>
                ...
                <div className="card text-center card-shadow on-hover border-0 mb-4">
                  <div className="card-body font-14">
                    ...
                    <h6 className="subtitle font-weight-normal">
                      {" "}
                      Updates will be Made within 3 to 5 Business days.
                    </h6>
                    <div className="pricing my-3">
                      ...
                      <span className="d-block">
                        {" "}
                        <span className="font-weight-medium">TTC</span>
                      </span>
                    </div>
                    <ul className="list-inline">
                      <li className="d-block py-2">
                        Adding New Pages (2 Pages/Month)
                      </li>
                      <li className="d-block py-2">
                        Adding New Posts (4 Posts/Month)
                      </li>
                      <li className="d-block py-2">
                        Updating Content (Up To 10 updates/Month){" "}
                      </li>

                      <li className="d-block py-2">
                        Page Design & layout updates (Once per page/Month)
                      </li>

                      <li className="d-block py-2">
                        images/photos editing, processing, and uploading (Up to
                        5)
                      </li>
                      <li className="d-block py-2">
                        Support Live Chat, Emails & Phone Calls ( 1 Hour/Month)
                      </li>
                    </ul>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="card text-center card-shadow on-hover border-0 mb-4">
                  <div className="card-body font-14">
                    ...
                    <h6 className="subtitle font-weight-normal">
                      Updates will be made within 1 to 2 days (Including
                      Weekends)
                    </h6>
                    <div className="pricing my-3">
                      <sup>MAD</sup>
                      <span className="monthly display-5 green-color ">
                        2600
                      </span>
                    ...
                    <ul className="list-inline">
                      <li className="d-block py-2">
                        Adding New Pages (Up to 10 Pages)
                      </li>
                      <li className="d-block py-2">
                        Adding New Posts (Up to 12 Posts/Month)
                      </li>
                      <li className="d-block py-2">
                        Updating Content (Unlimited){" "}
                      </li>
                      <li className="d-block py-2">
                        Page Design & layout updates (Up to 5 Pages/Month)
                      </li>
                      <li className="d-block py-2">
                        images/photos editing, processing, and uploading (Up to
                        15)
                      ...
                      <li className="d-block py-2">
                        Support Live Chat, Emails & Phone Calls (1 Hour/Week)
                      </li>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="card text-center card-shadow on-hover border-0 mb-4">
                  <div className="card-body font-14">
                    ...
                    <h6 className="subtitle font-weight-normal">
                      For newbies in affiliate marketing
                    </h6>
                    <div className="pricing my-3">
                      <sup>$</sup>
                      ...
                      <small className="yearly">/yr</small>
                      <span className="d-block">
                        Save <span className="font-weight-medium">$50</span> a
                        Year
                      </span>
                    </div>
                    <ul className="list-inline">
                      ...
                      <li className="d-block py-2">
                        Find Amazon broken products
                      </li>
                      <li className="d-block py-2">
                        Find missing Affiliate tags
                      </li>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-12 text-center ">
            <h3 className="mt-3 pricing_title mb-1">
              You can choose number of pages <br /> instead of monthlty
              subscription
            </h3>
            <h6 className="pricing_subtitle py-3">
              Choose the Right Plan for you
            </h6>
          </div>
              ...
              <div className="card" style={{ width: "14rem" }}>
                <div className="card-body d-flex ">
                  <p className="card-text align-items-center d-flex justify-content-center">
                    Unlimited <br /> Site Audit Reports
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-12 text-center ">
              ...
              <h6 className="pricing_subtitle py-3">
                If you are heastating, do not worry - we are here to explain{" "}
                <br /> ecrything you mihgt want to know, Let us help!
              </h6>
            </div>
          </div>
          <div className="row">
